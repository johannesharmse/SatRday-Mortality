...
#Underlying.list = unique(training.df$UnderlyingBroadGrp)
   ...
   sidebarLayout(
     sidebarPanel(
      ...
      #bsButton 
       ...
       p(actionButton("male", img(src = "male.png", width = "72px", height = "72px")), 
         actionButton("female", img(src = "female.jpg", width = "72px", height = "72px"))),
       p(actionButton("smoking", img(src = "smoking.png", width = "72px", height = "72px")), 
         actionButton("nosmoking", img(src = "nosmoking.png", width = "72px", height = "72px"))), 
       ...
       selectInput("MStatus", "Marital Status", choices = sort(unique(training.df$MStatus)), selected = paste(unique(training.df$MStatus)[[1]])),
       ...
       selectInput("OccupationGrp", "Occupation", choices = sort(unique(training.df$OccupationGrp), selected = sort(unique(training.df$OccupationGrp)[[1]]))),
       ...
       selectInput("UnderlyingBroadGrp", label = "Illness", choices = sort(gsub("\\.\\.\\.", "\\-", unique(training.df$UnderlyingBroadGrp))), selected = gsub("\\.\\.\\.", "\\-", paste(sort(unique(training.df$UnderlyingBroadGrp))[[1]])))  
...
#              input$UnderlyingBroadGrp, "</a>", " is most likely to die between the ages of <b>", variables.list()[["minage"]], 
